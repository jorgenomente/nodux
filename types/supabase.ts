  ...
  public: {
    Tables: {
      audit_log: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ["branch_id"]
            isOneToOne: false
            referencedRelation: "v_superadmin_subscription_detail"
            referencedColumns: ["branch_id"]
          },
          {
            foreignKeyName: "audit_log_branch_id_fkey"
          ...
          },
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "v_org_membership"
          ...
          },
          {
            ...
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "v_superadmin_subscriptions"
            referencedColumns: ["org_id"]
          },
        ]
      }
      ...
      org_subscription_cycles: {
        Row: {
          active_branch_count_snapshot: number
          billable_additional_branch_count_snapshot: number
          created_at: string
          ...
          discount_mode_snapshot: Database["public"]["Enums"]["subscription_discount_mode"]
        ...
        Relationships: [
          {
            foreignKeyName: "org_subscription_cycles_org_subscription_id_fkey"
          ...
          },
          {
            ...
            columns: ["org_subscription_id"]
            isOneToOne: false
            referencedRelation: "v_org_membership_payments"
            referencedColumns: ["subscription_id"]
          },
          {
            foreignKeyName: "org_subscription_cycles_org_subscription_id_fkey"
      ...
      org_subscription_payments: {
        Row: {
          ...
          id: string
          org_id: string
          org_subscription_cycle_id: string
          ...
          review_note: string | null
          review_status: Database["public"]["Enums"]["subscription_review_status"]
          reviewed_at: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "org_subscription_payments_org_id_fkey"
            columns: ["org_id"]
            isOneToOne: false
            referencedRelation: "orgs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "org_subscription_payments_org_subscription_cycle_id_fkey"
            columns: ["org_subscription_cycle_id"]
            isOneToOne: false
            referencedRelation: "org_subscription_cycles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "org_subscription_payments_org_subscription_cycle_id_fkey"
      ...
      org_subscriptions: {
        Row: {
          additional_branch_price_monthly_snapshot: number
          base_price_monthly_snapshot: number
          billing_notes_internal: string | null
          created_at: string
          created_by: string | null
          currency_code: string
          custom_monthly_price: number | null
          customer_note_visible: string | null
          discount_amount: number | null
          discount_label: string | null
          discount_mode: Database["public"]["Enums"]["subscription_discount_mode"]
          discount_percent: number | null
          grace_until: string | null
          id: string
          included_branches_snapshot: number
          is_auto_branch_pricing_enabled: boolean
          org_id: string
          plan_id: string | null
          plan_name_snapshot: string
          pricing_mode: Database["public"]["Enums"]["subscription_pricing_mode"]
          renews_on: string
          service_status: Database["public"]["Enums"]["subscription_service_status"]
          started_on: string
          updated_at: string
          updated_by: string | null
        }
    ...
    Views: {
      ...
      v_org_membership: {
        Row: {
          ...
          additional_branch_price_monthly: number | null
          bank_account_holder: string | null
          bank_account_type: string | null
          bank_alias: string | null
          bank_cbu: string | null
          ...
          billable_additional_branch_count: number | null
          ...
          discount_label: string | null
          discount_mode:
            | Database["public"]["Enums"]["subscription_discount_mode"]
            | null
          discount_percent: number | null
          effective_monthly_price: number | null
          included_branches: number | null
          ...
          pricing_mode:
            | Database["public"]["Enums"]["subscription_pricing_mode"]
            | null
          renews_on: string | null
          service_status:
            | Database["public"]["Enums"]["subscription_service_status"]
            | null
      ...
      v_org_membership_payments: {
        Row: {
          ...
          review_note: string | null
          review_status:
            | Database["public"]["Enums"]["subscription_review_status"]
            | null
          reviewed_at: string | null
      ...
      v_superadmin_subscription_detail: {
        Row: {
          ...
          current_cycle_payment_confirmed_at: string | null
          current_cycle_payment_status:
            | Database["public"]["Enums"]["subscription_payment_status"]
            | null
          current_cycle_start_on: string | null
    ...
    Functions: {
      fn_calculate_org_subscription_amount:
        | {
            Args: {
              p_additional_branch_price_monthly: number
              p_base_price_monthly: number
              p_custom_monthly_price?: number
              p_included_branches: number
              p_org_id: string
              p_pricing_mode: Database["public"]["Enums"]["subscription_pricing_mode"]
            }
            Returns: {
        ...
        | {
            Args: {
              ...
              p_discount_mode?: Database["public"]["Enums"]["subscription_discount_mode"]
      ...
      fn_recompute_org_subscription_cycle: {
        Args: {
          p_actor_user_id?: string
          p_cycle_id?: string
          p_org_subscription_id: string
        }
        Returns: string
      }
      ...
      fn_sync_supplier_payable_from_order: {
        Args: { p_actor_user_id?: string; p_order_id: string; p_org_id: string }
        Returns: string
      }
      ...
      normalize_product_category_tags: {
        Args: { p_tags: string[] }
        Returns: string[]
      }
      ...
      rpc_create_org_subscription_payment_submission: {
        Args: {
          p_amount_reported: number
          p_cycle_id: string
          p_payment_method: Database["public"]["Enums"]["subscription_payment_method"]
      ...
      rpc_set_branch_active_status: {
        Args: { p_branch_id: string; p_is_active: boolean; p_reason?: string }
        Returns: string
      }
      ...
      rpc_set_org_active_status: {
        Args: { p_is_active: boolean; p_org_id: string; p_reason?: string }
        Returns: string
      }
      rpc_set_org_subscription_cycle_payment_status: {
        Args: {
          ...
          p_paid_at?: string
          p_payment_id?: string
          p_payment_status: Database["public"]["Enums"]["subscription_payment_status"]
      ...
      rpc_set_org_subscription_service_status: {
        Args: {
          ...
          p_org_id: string
          p_reason?: string
          p_service_status: Database["public"]["Enums"]["subscription_service_status"]
        }
        Returns: string
      }
      ...
      rpc_upsert_org_subscription:
        | {
            Args: {
              p_additional_branch_price_monthly_snapshot?: number
              p_base_price_monthly_snapshot?: number
              p_billing_notes_internal?: string
              p_currency_code?: string
              p_custom_monthly_price?: number
              p_customer_note_visible?: string
              p_cycle_due_on?: string
              p_cycle_end_on?: string
              p_cycle_start_on?: string
              p_discount_amount?: number
              p_discount_label?: string
              p_discount_mode?: Database["public"]["Enums"]["subscription_discount_mode"]
              p_discount_percent?: number
              p_grace_until?: string
              p_included_branches_snapshot?: number
              p_is_auto_branch_pricing_enabled?: boolean
              p_org_id: string
              p_plan_id?: string
      ...
      rpc_upsert_platform_billing_settings: {
        Args: {
          ...
          p_bank_name?: string
          p_is_active?: boolean
          p_mercadopago_qr_image_path?: string
    ...
    Enums: {
      ...
      stock_movement_type:
        ...
        | "branch_transfer"
      subscription_discount_mode: "none" | "percent" | "fixed_amount"
