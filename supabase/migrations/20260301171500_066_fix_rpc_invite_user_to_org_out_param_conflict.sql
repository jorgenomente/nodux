-- Hotfix: OUT param `user_id` conflicts with SQL column references inside PL/pgSQL.
-- Rename output column to avoid ambiguity while keeping same call contract on inputs.
