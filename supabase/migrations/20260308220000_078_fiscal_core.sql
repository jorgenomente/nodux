...
drop policy if exists fiscal_credentials_service_role_all on public.fiscal_credentials;
create policy fiscal_credentials_service_role_all
...
drop policy if exists points_of_sale_service_role_all on public.points_of_sale;
create policy points_of_sale_service_role_all
...
drop policy if exists fiscal_sequences_service_role_all on public.fiscal_sequences;
create policy fiscal_sequences_service_role_all
...
drop policy if exists sale_documents_service_role_all on public.sale_documents;
create policy sale_documents_service_role_all
...
drop policy if exists invoice_jobs_service_role_all on public.invoice_jobs;
create policy invoice_jobs_service_role_all
...
drop policy if exists invoice_events_service_role_all on public.invoice_events;
create policy invoice_events_service_role_all
