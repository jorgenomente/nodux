...
- 2026-03-03: `/products` incorpora upload de imagen comprimida por producto (alta/edición) con Storage `product-images` y persistencia en `products.image_url`; storefront público compacta cards para mostrar más artículos por vista.
